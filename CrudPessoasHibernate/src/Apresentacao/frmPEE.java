...
public class frmPEE extends javax.swing.JDialog
{
    ...
    private void PesquisarPorID()
    {
        ...
        {
            txfID.setText(Integer.toString(pessoa.getId()));
    ...
    private void PesquisarPorNome()
    {
        ...
        if (controle.mensagem.equals(""))
        {
            if (atbEstaticos.listaPessoasEstatico.size() == 0)
                JOptionPane.showMessageDialog(null, "Não existe registro para esta pesquisa");

            if (atbEstaticos.listaPessoasEstatico.size() == 1)
            {
                Pessoa pessoa = atbEstaticos.listaPessoasEstatico.get(0);
                txfID.setText(String.valueOf(pessoa.getId()));
                txfNome.setText(pessoa.getNome());
                txfRG.setText(pessoa.getRg());
                txfCPF.setText(pessoa.getCpf());
            }
